...
CREATE TABLE `programming` (
  `programming_id` bigint NOT NULL AUTO_INCREMENT,
  `expected_output` varchar(255) DEFAULT NULL,
  `reference_answer` longtext NOT NULL,
  `question_id` bigint DEFAULT NULL,
  PRIMARY KEY (`programming_id`),
  KEY `FKev3k4uha5cpoxpje9swlalpf7` (`question_id`),
  CONSTRAINT `FKev3k4uha5cpoxpje9swlalpf7` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`)
