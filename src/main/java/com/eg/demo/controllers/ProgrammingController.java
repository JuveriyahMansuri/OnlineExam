...
//    @PutMapping("/{id}")
//    public Programming updateProgramming(@PathVariable Long id, @RequestBody Programming programmingDetails) {
//        return programmingRepositoryObj.findById(id).map(existingProgramming -> {
//            // Update relationships if provided
//            if (programmingDetails.getQuestion() != null) {
//                Question questionObj = questionRepositoryObj.findById(programmingDetails.getQuestion().getQuestion_id())
//                        .orElseThrow(() -> new RuntimeException("Question not found"));
//                existingProgramming.setQuestion(questionObj);
//            }
//
//            // Update other fields
//            existingProgramming.setExpected_output(programmingDetails.getExpected_output());
//            existingProgramming.setReference_answer(programmingDetails.getReference_answer());
//
